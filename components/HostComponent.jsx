...
const HostComponent = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p className="mt-[10px] font-normal lg:text-[20px] text-[14px] text-secondary-white">Individuals can host their own events on the platform for a nominal hosting fee.These NFTs can also be used to verify users and provide access not only to offline events but also to online token-gated meetings.
