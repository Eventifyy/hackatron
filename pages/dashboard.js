...
<a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">{prop.venue}
</a>

<p className="mt-[10px] font-normal lg:text-[20px] text-[14px] text-gray-500">
{prop.description}
</p>              <button className=" inline-flex items-center justify-center rounded-md border border-transparent bg-[#8A42D8] w-full px-2 py-2 text-base font-medium text-black shadow-sm hover:bg-indigo-700" onClick={prop.buyLink}>Buy Now</button> 
    ...
    <section class="text-white body-font  bg-[#151c25] overflow-hidden">
      ...
      <div class="container px-5 py-24 mx-auto">
        ...
        <div className="grid grid-cols-3 items-start h-[100vh] ">
          ...
          { (loaded == true && !items.length)? <h1 className="p-10 m-10 items-center font-semibold text-3xl ">No tickets bought!</h1> : items.map((item, i) => (
              <Card 
              key={1}
              price={item.price}
              name={item.name}
