...
export default function Dashboard() {
  ...
  return (
    <section class="text-white body-font  bg-[#151c25] overflow-hidden">
      ...
      <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">{item.venue}
      </a>

      <p className="mt-[10px] font-normal lg:text-[20px] text-[14px] text-gray-500">
        {item.description}
      </p>              <button className=" inline-flex items-center justify-center rounded-md border border-transparent bg-[#8A42D8] w-full px-2 py-2 text-base font-medium text-black shadow-sm hover:bg-indigo-700" onClick={item.buyLink}>Buy Now</button> 
